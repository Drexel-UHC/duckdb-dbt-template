...
export_dataset <- function(sim_data){
  ...
  sim_data %>% arrow::write_csv_arrow(sink = glue("../external-dev/sources/{dataset_id}.csv"))
  sim_data %>% arrow::write_parquet(sink = glue("../external-dev/sources/{dataset_id}.parquet"))
